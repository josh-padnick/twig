...
configured [opener set](/twig/guides/openers/). Bare `twig` inside a repo
...
worktree. See [the trust model](/twig/guides/trust/).

## twig shell-init <zsh|bash|fish> [--cmd tw]

Emits the [`tw` shell function](/twig/guides/shell-integration/).
